"""
Django settings for codesolid_demo project.
...
SECRET_KEY = 'django-insecure-k^r@s)s+_4v$i(ck9x0m$-&wxpqt(z_4af*j)56nu1a=#%m3n7'
...
ROOT_URLCONF = 'codesolid_demo.urls'
...
WSGI_APPLICATION = 'codesolid_demo.wsgi.application'
